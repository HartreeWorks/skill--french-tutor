...
A Claude Code skill for French language tutoring - translation, correction, and answering questions about French.
...
```bash
npx skills add HartreeWorks/skill--french-tutor
```
